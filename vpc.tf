...
resource "aws_security_group" "seurity_group_05" {
  ...
  ingress {
    ...
    to_port     = 3306
    protocol    = "tcp"
    cidr_blocks = ["10.0.0./16", "201.17.157.23/32", "172.31.26.154/32", "172.31.28.100/32", "18.230.146.107/32", "172.31.18.102/32"]
  }
  ...
  ingress {
    ...
    to_port     = 5432
    protocol    = "tcp"
    cidr_blocks = ["10.0.0./16", "177.42.94.34/32", "191.185.78.56/32", "172.31.26.154/32", "177.42.81.119/32", "191.34.39.253/32", "179.0.73.151/32", "187.111.26.6/32", "172.31.22.123/32", "186.206.255.44/32", "201.17.157.236/32", "179.184.192.19/32", "179.251.108.107/32", "191.35.59.48/32", "201.16.205.241/32", "172.31.29.21/32", "177.55.225.128/32", "187.72.246.105/32"]
  }
